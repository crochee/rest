...
func Get() RESTClient {
	return NewRESTClient(DefaultTransport, http.MethodGet)
}

func Post() RESTClient {
	return NewRESTClient(DefaultTransport, http.MethodPost)
}

func Put() RESTClient {
	return NewRESTClient(DefaultTransport, http.MethodPut)
}

func Patch() RESTClient {
	return NewRESTClient(DefaultTransport, http.MethodPatch)
}

func Delete() RESTClient {
	return NewRESTClient(DefaultTransport, http.MethodDelete)
}
